...
| Checkpoint→Isaac eval | 🔶 Pending | policy_wrapper.py written, need to run 1000ep with target-impact checkpoint |
| RK3588 export | ⏳ Pending | After Isaac policy validation |
